            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <br>
                            <div class="col-lg-12" >
                                <!--<img src="pics/about(yeah).jpg" style="width:100%"><br><br> -->
                                ...
                                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                  ...
                                  <div class="carousel-inner" role="listbox">
                                    <div class="item active">
                                      <img src="pics/gym.jpg" alt="Project Agent">
                                    </div>

                                    <div class="item">
                                      <img src="pics/tree.jpg" alt="Project Agent">
                                    </div>

                                    <div class="item">
                                      <img src="pics/roadwidening.jpg" alt="Project Agent">
                                    </div>

                                    <div class="item">
                                      <img src="pics/sewage.jpg" alt="Project Agent">
                                    </div>
                                  </div>
